...
* (32767) database arguments: a zero-terminated key=value string (may
  appear multiple times, unlikely most types); used by the kadmin
  protocol to communicate -x arguments to kadmind
...
field "version_numbe" contains 0x12345C01.  The aux_attributes field
