...
**-R**
    ...
    :ref:`klist(1)` may sometimes be renewed using this option, as
    there is a grace-period applied to account for client-KDC clock
    skew.  See :ref:`krb5.conf(5)` **clockskew** setting.
