...
realm.run(['./t_bindings', server, '-', '-'], expected_msg='yes')
...
realm.run(['./t_bindings', '-s', server, '-', '-'], expected_msg='yes')
...
realm.run(['./t_bindings', server, '-', '-'], env=e, expected_msg='yes')
...
realm.run(['./t_bindings', '-s', server, '-', '-'], env=e, expected_msg='yes')
...
realm.run(['./t_bindings', '-b', server, '-', '-'], expected_msg='yes')
...
realm.run(['./t_bindings', '-s', '-b', server, '-', '-'], expected_msg='yes')
