...
check_lifetime('actx gss_accept_sec_context', ln[7], 8000 * 86400)
check_lifetime('actx gss_inquire_context', ln[8], 8000 * 86400)
check_lifetime('actx gss_context_time', ln[9], 8000 * 86400)
