...
!endif
  ...
  !define SXSDIR1     "$%SystemRoot%\WinSxS\x86_Microsoft.VC80.DebugCRT_1fc8b3b9a1e18e3b_8.0.50727.762_x-ww_5490cd9f"
  !define SXSLANG     "c:\Program Files\Microsoft Visual Studio 8\VC\redist\x86\Microsoft.VC80.MFCLOC"
  !ifdef X86
  !define SXSDIR2     "$%SystemRoot%\WinSxS\x86_Microsoft.VC80.DebugMFC_1fc8b3b9a1e18e3b_8.0.50727.42_x-ww_c8452471"
  !define SXSMAND     "$%SystemRoot%\WinSxS\Manifests"
  !else
  !ifdef AMD64
  !define SXSDIR2     "$%SystemRoot%\WinSxS\amd64_Microsoft.VC80.DebugMFC_1fc8b3b9a1e18e3b_8.0.50727.762_x-ww_57812684"
  !endif
  !endif
  
  !define REDISTDIR   "c:\Program Files\Microsoft Visual Studio 8\SDK\v2.0\BootStrapper\Packages\vcredist_x86"
...
!ifdef DEBUG
!IFDEF CL_1400
  !insertmacro ReplaceDLL "${SXSDIR1}\msvcr80d.dll"      "$INSTDIR\bin\msvcr80d.dll"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSDIR1}\msvcp80d.dll"      "$INSTDIR\bin\msvcp80d.dll"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSDIR2}\mfc80d.dll"        "$INSTDIR\bin\mfc80d.dll"    "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80CHS.DLL"      "$INSTDIR\bin\MFC80CHS.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80CHT.DLL"      "$INSTDIR\bin\MFC80CHT.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80DEU.DLL"      "$INSTDIR\bin\MFC80DEU.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80ENU.DLL"      "$INSTDIR\bin\MFC80ENU.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80ESP.DLL"      "$INSTDIR\bin\MFC80ESP.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80FRA.DLL"      "$INSTDIR\bin\MFC80FRA.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80ITA.DLL"      "$INSTDIR\bin\MFC80ITA.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80JPN.DLL"      "$INSTDIR\bin\MFC80JPN.DLL"  "$INSTDIR"
  !insertmacro ReplaceDLL "${SXSLANG}\MFC80KOR.DLL"      "$INSTDIR\bin\MFC80KOR.DLL"  "$INSTDIR"
  !IFDEF X86
  !insertmacro ReplaceDLL   "${SXSMAND}\x86_Microsoft.VC80.DebugMFC_1fc8b3b9a1e18e3b_8.0.50727.762_x-ww_257740a4.manifest"   "$INSTDIR\bin\x86_Microsoft.VC80.DebugMFC_1fc8b3b9a1e18e3b_8.0.50727.762_x-ww_257740a4.manifest"  "$INSTDIR"
  !ELSE
  !IFDEF AMD64
  !insertmacro ReplaceDLL "${SXSMAND}\AMD64_Microsoft.VC80.DebugMFC_1fc8b3b9a1e18e3b_8.0.50727.762_x-ww_257740a4.manifest" "$INSTDIR\bin\AMD64_Microsoft.VC80.DebugMFC_1fc8b3b9a1e18e3b_8.0.50727.762_x-ww_257740a4.manifest"  "$INSTDIR"
  !ENDIF
  !ENDIF
!ELSE                                                                   
!IFDEF CL_1310
...
!IFDEF CL_1400
!IFDEF X86
  File "$%SystemRoot%\symbols\dll\msvcr80d.i386.pdb"
  File "$%SystemRoot%\symbols\dll\msvcp80d.i386.pdb"
  File "$%SystemRoot%\symbols\dll\mfc80d.i386.pdb"
!ELSE
!IFDEF AMD64
  File "$%SystemRoot%\symbols\dll\msvcr80d.AMD64.pdb"
  File "$%SystemRoot%\symbols\dll\msvcp80d.AMD64.pdb"
  File "$%SystemRoot%\symbols\dll\mfc80d.AMD64.pdb"
!ENDIF  ; AMD64
!ENDIF  ; X86  
!ELSE   ; NOT CL_1400                                                                
!IFDEF CL_1310
