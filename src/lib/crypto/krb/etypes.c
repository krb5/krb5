...
const struct krb5_keytypes krb5int_enctypes_list[] = {
    ...
    { ENCTYPE_AES128_CCM_128,
      ...
      "AES-128 CCM mode with 128-bit CMAC",
    ...
    { ENCTYPE_AES256_CCM_128,
      ...
      "AES-256 CCM mode with 128-bit CMAC",
    ...
    { ENCTYPE_CAMELLIA128_CTS_HMAC_SHA1_96,
      ...
      "Camellia-128 CTS mode with 96-bit SHA-1 HMAC",
      &krb5int_enc_camellia128, &krb5int_hash_sha1,
      16,
      krb5int_camellia_crypto_length, krb5int_dk_encrypt, krb5int_dk_decrypt,
      krb5int_camellia_string_to_key,
      krb5int_dk_prf,
      CKSUMTYPE_HMAC_SHA1_96_CAMELLIA128,
      0 /*flags*/ },
    { ENCTYPE_CAMELLIA256_CTS_HMAC_SHA1_96,
      "camellia256-cts-hmac-sha1-96", { "camellia256-cts" },
      "Camellia-256 CTS mode with 96-bit SHA-1 HMAC",
      &krb5int_enc_camellia256, &krb5int_hash_sha1,
      16,
      krb5int_camellia_crypto_length, krb5int_dk_encrypt, krb5int_dk_decrypt,
      krb5int_camellia_string_to_key,
      krb5int_dk_prf,
    ...
    { ENCTYPE_CAMELLIA128_CCM_128,
      ...
      "Camellia-128 CCM mode with 128-bit CMAC",
    ...
    { ENCTYPE_CAMELLIA256_CCM_128,
      ...
      "Camellia-256 CCM mode with 128-bit CMAC",
