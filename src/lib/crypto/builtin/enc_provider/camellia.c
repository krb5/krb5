...
/*
 * lib/crypto/enc_provider/camellia.c
 *
...
krb5_error_code
krb5int_camellia_encrypt(krb5_key key, const krb5_data *ivec, krb5_crypto_iov *data,
                    size_t num_data)
{
    camellia_ctx ctx;
    ...
    if (camellia_enc_key(key->keyblock.contents, key->keyblock.length, &ctx)
        != camellia_good)
        abort();
...
krb5_error_code
krb5int_camellia_decrypt(krb5_key key, const krb5_data *ivec, krb5_crypto_iov *data,
                    size_t num_data)
{
    camellia_ctx ctx;
