...
/* Glue routine for gss_acquire_cred_impersonate_cert */
...
static OM_uint32
val_acq_cred_impersonate_cert_args(
...
gss_acquire_cred_impersonate_cert(OM_uint32 *minor_status,
				  const gss_cred_id_t impersonator_cred_handle,
				  const gss_name_t desired_name,
				  const gss_buffer_t cert_data,
				  OM_uint32 time_req,
				  ...
				  OM_uint32 *time_rec)
{
    ...
    major = val_acq_cred_impersonate_cert_args(minor_status,
	...
	major = gss_add_cred_impersonate_cert(minor_status,
					      (gss_cred_id_t)creds,
					      impersonator_cred_handle,
					      desired_name,
					      cert_data,
...
static OM_uint32
val_add_cred_impersonate_cert_args(
    OM_uint32 *minor_status,
...
/* V2 KRB5_CALLCONV */
OM_uint32 KRB5_CALLCONV
gss_add_cred_impersonate_cert(OM_uint32 *minor_status,
			      gss_cred_id_t input_cred_handle,
			      const gss_cred_id_t impersonator_cred_handle,
			      const gss_name_t desired_name,
			      const gss_buffer_t cert_data,
			      ...
			      OM_uint32 *acceptor_time_rec)
{
    ...
    status = val_add_cred_impersonate_cert_args(minor_status,
						input_cred_handle,
						impersonator_cred_handle,
						desired_name,
						cert_date,
    ...
    if (!mech)
	return GSS_S_BAD_MECH;
    else if (!mech->gss_acquire_cred_impersonate_cert)
    ...
    status = mech->gss_acquire_cred_impersonate_cert(minor_status,
						     mech_impersonator_cred,
						     internal_name,
						     cert_data,
						     time_req,
