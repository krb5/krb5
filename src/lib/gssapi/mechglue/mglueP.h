...
/*
 * This table is used to indirectly access mechanism specific versions of the
 * gssapi routines through the routines in the glue module (g_glue.c).  It
 * contains all of the functions defined in gssapi.h except for
